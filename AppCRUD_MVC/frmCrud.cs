...
namespace AppCRUD_MVC
{
    public partial class frmCrud : Form
    {
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(" Por favor, preencha todo o formulario", "Campos Obrigatorios", MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        private void btnExcluir_Click(object sender, EventArgs e)
        {
            ...
            Pessoa pessoa = new Pessoa();
            pessoa.Excluir(id);
            MessageBox.Show("Pessoa Excluida com sucesso!", "Exclusão", MessageBoxButtons.OK, MessageBoxIcon.Information);
            txtNome.Text = string.Empty;
            txtIdade.Text = string.Empty;
            txtId.Text = string.Empty;
            List<Pessoa> pes = pessoa.ListarPessoas();
